...
datay1 = np.loadtxt('totalEdgePowerSystemOP.txt', usecols=[0])


datax2 = np.loadtxt('totalChainActiveBL.txt', usecols=[0])
datay2 = np.loadtxt('totalEdgePowerSystemBL.txt', usecols=[0])
...
datay3 = np.loadtxt('totalEdgePowerSystemBLRD.txt', usecols=[0])
...
datay4 = np.loadtxt('totalEdgePowerSystemSFCCM.txt', usecols=[0])

#datax5 = np.loadtxt('totalChainActiveSFCCMOP.txt', usecols=[0])
#datay5 = np.loadtxt('totalEdgePowerSystemSFCCMOP.txt', usecols=[0])

plt.plot(datax1, datay1, color = 'r', label = "OP Algorithm")
#plt.plot(datax2, datay2, color = 'k', label = "BL Algorithm")
plt.plot(datax3, datay3, color = 'b', label = "BL algorithm")
plt.plot(datax4, datay4, color = 'g', label = "SFCCM algorithm")
#plt.plot(datax5, datay5, color = 'c', label = "SFCCMOP algorithm")
