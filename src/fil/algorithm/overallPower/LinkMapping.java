...
public class LinkMapping implements java.io.Serializable{
	...
	public Topology linkMappingOurAlgorithm(Topology topo,
		...
		listVirLink.clear();
		numLinkSuccess=0;
		resultsLinkMapping = new HashMap<>(); //moi them
		listBandwidthPhyEdge.clear();
		...
		while(!remainCopy.isEmpty()) {
			...
			if(phy2Edge1 == null || phy2Edge2 == null) {
				throw new java.lang.Error("Name not defined");
			}
...
//		}
	...
	public boolean isSuccess() {
		return isSuccess = true; // change to skip functon
	}
