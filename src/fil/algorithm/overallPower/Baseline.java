...
//		}/////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		try {
			write_double("./PlotBaseline/linklistCoreAggBL.txt",listCoreAgg);
			write_double("./PlotBaseline/linklistAggEdgeBL.txt",listAggEdge);
			write_double("./PlotBaseline/linklinkPhyEdgeBL.txt",linkPhyEdge);
			write_double("./PlotBaseline/linkBandwidthBL.txt",linkBandwidth);
			write_double("./PlotBaseline/serverUtilizationBL.txt",serverUtilization);
			write_integer("./PlotBaseline/totalChainLeaveBL.txt",totalChainLeave);
			write_integer("./PlotBaseline/listServerUsedBL.txt",listServerUsed);
			write_integer("./PlotBaseline/requestRandomBL.txt",requestRandomReceive);
			write_integer("./PlotBaseline/totalDecOffloadBL.txt",totalDecOffload);
			write_integer("./PlotBaseline/totalDenOffloadBL.txt",totalDenOffload);
			write_double("./PlotBaseline/totalPowerSystemBL.txt",totalPowerSystem);
			write_double("./PlotBaseline/totalEdgePowerSystemBL.txt", totalEdgePowerSystem);
			write_double("./PlotBaseline/totalLoadEdgeBL.txt",totalLoadEdge);
			write_double("./PlotBaseline/totalBwEdgeBL.txt",totalBwEdge);
			write_double("./PlotBaseline/totalChainAcceptanceBL.txt",totalChainAcceptance);
			write_double("./PlotBaseline/sumLoadNumPiBL.txt", sumLoadNumPi);
			write_double("./PlotBaseline/sumBwNumPiBL.txt", sumBwNumPi);
			write_integer("./PlotBaseline/totalChainSystemBL.txt",totalChainSystem);
			write_integer("./PlotBaseline/totalChainActiveBL.txt",totalChainActive);
			write_integer("./PlotBaseline/totalChainRejectBL.txt",totalChainReject);
			write_integer("./PlotBaseline/numChainRequestBL.txt",numChainRequest);
		} catch (IOException e) {
