...
//		}/////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		try {
			...
			write_double("./PlotSFCCM/linklistCoreAggSFCCM.txt",listCoreAgg);
			write_double("./PlotSFCCM/linklistAggEdgeSFCCM.txt",listAggEdge);
			write_double("./PlotSFCCM/linklinkPhyEdgeSFCCM.txt",linkPhyEdge);
			write_double("./PlotSFCCM/linkBandwidthSFCCM.txt",linkBandwidth);
			write_double("./PlotSFCCM/serverUtilizationSFCCM.txt",serverUtilization);
			write_integer("./PlotSFCCM/totalChainLeaveSFCCM.txt",totalChainLeave);
			write_integer("./PlotSFCCM/listServerUsedSFCCM.txt",listServerUsed);
			write_integer("./PlotSFCCM/requestRandomSFCCM.txt",requestRandomReceive);
			write_integer("./PlotSFCCM/totalDecOffloadSFCCM.txt",totalDecOffload);
			write_integer("./PlotSFCCM/totalDenOffloadSFCCM.txt",totalDenOffload);
			write_double("./PlotSFCCM/totalPowerSystemSFCCM.txt",totalPowerSystem);
			write_double("./PlotSFCCM/totalEdgePowerSystemSFCCM.txt", totalEdgePowerSystem);
			write_double("./PlotSFCCM/totalLoadEdgeSFCCM.txt",totalLoadEdge);
			write_double("./PlotSFCCM/totalBwEdgeSFCCM.txt",totalBwEdge);
			write_double("./PlotSFCCM/totalChainAcceptanceSFCCM.txt",totalChainAcceptance);
			write_double("./PlotSFCCM/sumLoadNumPiSFCCM.txt", sumLoadNumPi);
			write_double("./PlotSFCCM/sumBwNumPiSFCCM.txt", sumBwNumPi);
			write_integer("./PlotSFCCM/totalChainSystemSFCCM.txt",totalChainSystem);
			write_integer("./PlotSFCCM/totalChainActiveSFCCM.txt",totalChainActive);
			write_integer("./PlotSFCCM/totalChainRejectSFCCM.txt",totalChainReject);
			write_integer("./PlotSFCCM/numChainRequestSFCCM.txt",numChainRequest);
			write_integer("./PlotSFCCM/numChainAcceptSFCCM.txt",numChainAccept);
		} catch (IOException e) {
