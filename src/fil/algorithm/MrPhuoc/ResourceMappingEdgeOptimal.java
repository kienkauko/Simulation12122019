...
public class ResourceMappingEdgeOptimal  {
	...
	public ResourceMappingEdgeOptimal() {;
		//numSFCTotal = 0;
	}
...
//		}/////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		try {
			write_double("./PlotMRP/EdgeOptimal/serverUtilizationMRP.txt",serverUtilization);
			write_integer("./PlotMRP/EdgeOptimal/listServerUsedMRP.txt",listServerUsed);
			write_integer("./PlotMRP/EdgeOptimal/requestRandomMRP.txt",requestRandomReceive);
			write_integer("./PlotMRP/EdgeOptimal/totalDecOffloadMRP.txt",totalDecOffload);
			write_integer("./PlotMRP/EdgeOptimal/totalDenOffloadMRP.txt",totalDenOffload);
			write_double("./PlotMRP/EdgeOptimal/totalPowerSystemMRP.txt",totalPowerSystem);
			write_double("./PlotMRP/EdgeOptimal/totalEdgePowerSystemMRP.txt", totalEdgePowerSystem);
			write_double("./PlotMRP/EdgeOptimal/totalLoadEdgeMRP.txt",totalLoadEdge);
			write_double("./PlotMRP/EdgeOptimal/totalBwEdgeMRP.txt",totalBwEdge);
			write_double("./PlotMRP/EdgeOptimal/totalChainAcceptanceMRP.txt",totalChainAcceptance);
			write_double("./PlotMRP/EdgeOptimal/sumLoadNumPiMRP.txt", sumLoadNumPi);
			write_double("./PlotMRP/EdgeOptimal/sumBwNumPiMRP.txt", sumBwNumPi);
			write_integer("./PlotMRP/EdgeOptimal/totalChainSystemMRP.txt",totalChainSystem);
			write_integer("./PlotMRP/EdgeOptimal/totalChainRejectMRP.txt",totalChainReject);
		} catch (IOException e) {
