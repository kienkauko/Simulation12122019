...
//		}/////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		try {
			write_double("./PlotBaselineMRP/linklistCoreAggBLMRP.txt",listCoreAgg);
			write_double("./PlotBaselineMRP/linklistAggEdgeBLMRP.txt",listAggEdge);
			write_double("./PlotBaselineMRP/linklinkPhyEdgeBLMRP.txt",linkPhyEdge);
			write_double("./PlotBaselineMRP/linkBandwidthBLMRP.txt",linkBandwidth);
			write_double("./PlotBaselineMRP/serverUtilizationBLMRP.txt",serverUtilization);
			write_integer("./PlotBaselineMRP/totalChainLeaveBLMRP.txt",totalChainLeave);
			write_integer("./PlotBaselineMRP/listServerUsedBLMRP.txt",listServerUsed);
			write_integer("./PlotBaselineMRP/requestRandomBLMRP.txt",requestRandomReceive);
			write_integer("./PlotBaselineMRP/totalDecOffloadBLMRP.txt",totalDecOffload);
			write_integer("./PlotBaselineMRP/totalDenOffloadBLMRP.txt",totalDenOffload);
			write_double("./PlotBaselineMRP/totalPowerSystemBLMRP.txt",totalPowerSystem);
			write_double("./PlotBaselineMRP/totalEdgePowerSystemBLMRP.txt", totalEdgePowerSystem);
			write_double("./PlotBaselineMRP/totalLoadEdgeBLMRP.txt",totalLoadEdge);
			write_double("./PlotBaselineMRP/totalBwEdgeBLMRP.txt",totalBwEdge);
			write_double("./PlotBaselineMRP/totalChainAcceptanceBLMRP.txt",totalChainAcceptance);
			write_double("./PlotBaselineMRP/sumLoadNumPiBLMRP.txt", sumLoadNumPi);
			write_double("./PlotBaselineMRP/sumBwNumPiBLMRP.txt", sumBwNumPi);
			write_integer("./PlotBaselineMRP/totalChainSystemBLMRP.txt",totalChainSystem);
			write_integer("./PlotBaselineMRP/totalChainActiveBLMRP.txt",totalChainActive);
			write_integer("./PlotBaselineMRP/totalChainRejectBLMRP.txt",totalChainReject);
			write_integer("./PlotBaselineMRP/numChainRequestBLMRP.txt",numChainRequest);
		} catch (IOException e) {
